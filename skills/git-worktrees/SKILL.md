...
**Called by:**
- **superpower-planning:brainstorming** (Phase 4) - REQUIRED when design is approved and implementation follows
- **superpower-planning:executing-plans** - REQUIRED before executing any tasks
